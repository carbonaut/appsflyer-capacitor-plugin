...
export interface AppsFlyerPlugin {
    addListener(eventName: AFConstants.CONVERSION_CALLBACK, listenerFunc: (event: OnConversionDataResult) => void): Promise<PluginListenerHandle>;
    addListener(eventName: AFConstants.OAOA_CALLBACK, listenerFunc: (event: OnAppOpenAttribution) => void): Promise<PluginListenerHandle>;
    addListener(eventName: AFConstants.UDL_CALLBACK, listenerFunc: (event: OnDeepLink) => void): Promise<PluginListenerHandle>;
    /**
